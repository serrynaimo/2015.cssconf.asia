...
<body class="loading">
	...
	<section id="intro">
	    <div>
            ...
            <p class="desc">
                <a href="http://blog.devfest.asia/early-buddy-tickets-for-cssconf-and-jsconf-asia/" style="color: white; text-decoration: none;" target="_blank">Tickets sales start <span id="countdown">this Friday</span></a>
            </p>
